...
<div class="sec-around">
  <div class="item1-around">
    <div class="tit-seccion-around"> 
      @field('tituloAmericana')
   </div>
  </div>
  ...
  <div class="imagen-plato"><img src="@field('imagenElementoAmericana','url')" alt="@field('imagenElementoAmericana','alt')"></div>

  <div class="camino-arround">
    @field('svgAmericana')
  </div>
</div>
