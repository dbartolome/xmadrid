...
<div class="cont-formulario" id="contenedor-formulario">
  <div class="capa-formulario">
    ...
    <div class="encabezado-form">
      <img src="@option('imgNewletter','url')" width="100%" alt="@option('imgNewletter','alt')">
      <div class="titular-encabezado">@option('titPopUp')</div>
      <div class="descripcion-encabezado">@option('descripcionPopup')</div>
    </div>
    <?php 
      $miShortCode = get_field('sortCode','option');
      
    ?>
    <div class="int-formulario"><?php echo do_shortcode($miShortCode);?></div>
  </div>
</div>