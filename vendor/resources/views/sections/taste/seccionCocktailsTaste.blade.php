...
?>
<div class="sec-cocktails">
  <div class="item1-cocktails">
   <div class="tit-seccion-cocktails"> 
    @field('tituloTerraceo')
   </div> 
  </div>
 ...
 <div class="img-terraza"><img src="@field('imagenElementoTerraceo','url')" alt="@field('imagenElementoTerraceo','alt')"></div>
</div>
