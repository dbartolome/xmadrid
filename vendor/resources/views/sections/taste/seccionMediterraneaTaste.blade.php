...
?>
<div class="sec-mediterranea">
<div class="item1-mediterranea">
   <div class="tit-seccion-mediterranea"> 
    @field('tituloMediterranea')
   </div>
...
<div class="imagen-plato"><img src="@field('imagenElementoMediterranea','url')" alt="@field('imagenElementoMediterranea','alt')"></div>

<div class="camino-mediterranea">
@field('svgMediterranea')
</div>
</div>